...
<body>
    ...
    <div data-role="main"  id="tabs">
        ...
        <div id="Div_Daily" class="ui-body-d ui-content" style="display: block">
            ...
            <p>
                <label for="txtCattleRegNo"><b>Cattle Reg. No.</b></label>
                <input type="text" name="txtCattleRegNo" id="txtCattleRegNo" />
            </p>
            <p>
                <label for="txtSellingPrice"><b>Selling Price (Rs.)</b></label>
            ...
            <div data-role="content">
                <table style="width: 60%;" align="center">
                    <tr>
                        <label for="txtUpdate_cattle_health."><b>Current Health Report</b></label>
                    </tr>
                    <tr>
                        <td align="center">
